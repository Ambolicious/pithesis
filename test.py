...
def main():
    ...
    c.add_sensor(ACS758IP(sensor_name='Battery Current (A2 0x49)', address=0x49, mode=2, current_offset=0.0, multiplier=1.0,gain=1.0))
    c.add_sensor(ACS758IP(sensor_name='Line Current (A3, 0x49)', address=0x49, mode=3, current_offset=0.0, gain=1.0))
